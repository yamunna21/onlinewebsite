  ...
  <nav class="navbar navbar-inverse">
    <div class="container-fluid">
      ...
      <ul class="nav navbar-nav navbar-right">
        <li><a href="../manageUserProfileView/runnerProfile.php?username=<?=$_SESSION['username']?>"><span class="glyphicon glyphicon-user"></span> Profile</a></li>
        <li><a href="../manageTrackingAndAnalyticView/runnerAnalytic.php?username=<?=$_SESSION['username']?>"><span class="glyphicon glyphicon-screenshot"></span> Analytic</a></li>
    ...
    <h3 style="margin-left: 1em; margin-top: 1em;text-decoration: underline;">Runner Profile</h3>
      <div style="margin-left: 1em;">
          ...
          <br />
          <button type="button" class="btn btn-danger" onclick="location.href='../manageTrackingAndAnalyticView/runnerHomePage.php?username=<?=$_SESSION['username']?>'">Cancel</button>
