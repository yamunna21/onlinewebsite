  ...
  <nav class="navbar navbar-inverse">
    <div class="container-fluid">
      <div class="navbar-header">
        <?php foreach($data as $row) { ?>
          <a class="navbar-brand" href="#">Welcome to Turbo Runner Delivery System, <?=$row['username']?></a>
      </div>
      <ul class="nav navbar-nav">
        ...
        <ul class="dropdown-menu">
          <li><a href="../manageOrderView/custHomePage.php?username=<?=$_SESSION['username']?>">Home</a></li>
          <li><a href="../manageOrderView/custProductList.php?username=<?=$_SESSION['username']?>&&product_category=Food">Food</a></li>
          <li><a href="../manageOrderView/custProductList.php?username=<?=$_SESSION['username']?>&&product_category=Goods">Goods</a></li>
          <li><a href="../manageOrderView/custProductList.php?username=<?=$_SESSION['username']?>&&product_category=Pet">Pet Assist</a></li>
          <li><a href="../manageOrderView/custProductList.php?username=<?=$_SESSION['username']?>&&product_category=Medical">Medical</a></li>
        </ul>
        </li>
      </ul>
      <ul class="nav navbar-nav navbar-right">
        <li><a href="../manageOrderView/cart.php?username=<?=$_SESSION['username']?>"><span class="glyphicon glyphicon-shopping-cart"></span> Shopping Cart</a></li>
        <li><a href="../manageUserProfileView/custProfile.php?username=<?=$_SESSION['username']?>"><span class="glyphicon glyphicon-user"></span> Profile</a></li>
        <li><a href="../manageTrackingAndAnalyticView/custTrack.php?username=<?=$_SESSION['username']?>"><span class="glyphicon glyphicon-map-marker"></span> Track</a></li>
        <li><a href="..//LoginView/index.html"><span class="glyphicon glyphicon-log-out"></span> Log Out</a></li>
      </ul>
    </div>
  </nav>
    <h3 style="margin-left: 1em; margin-top: 1em;text-decoration: underline;">Customer Profile</h3>
      <div style="margin-left: 1em;">
          ...
          <br />
          <button type="button" class="btn btn-danger" onclick="location.href='../../ApplicationLayer/manageOrderView/custHomePage.php?username=<?=$_SESSION['username']?>'">Cancel</button>
