  ...
  <nav class="navbar navbar-inverse">
    <div class="container-fluid">
      ...
      <ul class="nav navbar-nav navbar-right">
        <li><a href="../../ApplicationLayer/manageServiceView/addService.php?username=<?=$_SESSION['username']?>"><span class="glyphicon glyphicon-briefcase"></span> Add Product</a></li>
        <li><a href="../../ApplicationLayer/manageUserProfileView/spProfile.php?username=<?=$_SESSION['username']?>"><span class="glyphicon glyphicon-user"></span> Profile</a></li>
        <li><a href="../../ApplicationLayer/manageTrackingAndAnalyticView/spAnalytic.php?username=<?=$_SESSION['username']?>"><span class="glyphicon glyphicon-screenshot"></span> Analytic</a></li>
        <li><a href="../../ApplicationLayer/LoginView/index.html"><span class="glyphicon glyphicon-log-out"></span> Log Out</a></li>
      </ul>
    </div>
  </nav>
    <h3 style="margin-left: 1em; margin-top: 1em;text-decoration: underline;">Service Provider Profile</h3>
      <div style="margin-left: 1em;">
          ...
          <br />
          <button type="button" class="btn btn-danger" onclick="location.href='../../ApplicationLayer/manageServiceView/spHomePage.php?username=<?=$_SESSION['username']?>'">Cancel</button>
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h3 class="modal-title">Edit Profile | Service Provider</h3>
